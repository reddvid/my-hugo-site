...
David Ballesteros's Blog & Site ("us", "we", or "our") operates the http://www.reddavid.me website (the "Service").
...
* **Service**
<br>
<br> Service is the http://www.reddavid.me/ website operated by David Ballesteros, an Individual.

* **Personal Data**
<br>
<br> Personal data means data about a living individual who can be identified from those data (or from those and other information either in our possession or likely to come into our possession).

* **Usage Data**
<br>
<br> Usage Data is data collected automatically either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).

* **Cookies**
<br>
<br> Cookies are small pieces of data stored on your device (computer or mobile device).
...
<br>
<br> For the purpose of this Privacy Policy, we are a Data Controller of your Personal Data.
...
<br>
<br> We may use the services of various Service Providers in order to process your data more effectively.
